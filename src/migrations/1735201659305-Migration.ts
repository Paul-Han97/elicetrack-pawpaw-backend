...
export class Migration1735201659305 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`review_place_like\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdUser\` varchar(255) NULL DEFAULT 'PawPaw', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedUser\` varchar(255) NULL, \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`isLike\` tinyint NOT NULL, \`placeId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`place\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdUser\` varchar(255) NULL DEFAULT 'PawPaw', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedUser\` varchar(255) NULL, \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(255) NOT NULL, \`category\` varchar(255) NOT NULL, \`postalCode\` varchar(255) NOT NULL, \`roadNameAddress\` varchar(255) NOT NULL, \`postalAddress\` varchar(255) NOT NULL, \`contact\` varchar(255) NOT NULL, \`closingDays\` varchar(255) NOT NULL, \`openingHour\` varchar(255) NOT NULL, \`hasParkingArea\` tinyint NOT NULL, \`price\` varchar(255) NOT NULL, \`allowSize\` varchar(255) NOT NULL, \`restrictions\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`additionalFees\` varchar(255) NOT NULL, \`lastUpdate\` datetime NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`user_board_like\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdUser\` varchar(255) NULL DEFAULT 'PawPaw', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedUser\` varchar(255) NULL, \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`isLike\` tinyint NOT NULL, \`userId\` int NULL, \`boardId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
