...
export class Migration1735201659305 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`notification\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdUser\` varchar(255) NULL DEFAULT 'PawPaw', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedUser\` varchar(255) NULL, \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`isRead\` tinyint NOT NULL, \`chatId\` int NOT NULL, \`userId\` int NULL, \`notificationTypeId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`review_place_like\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdUser\` varchar(255) NULL DEFAULT 'PawPaw', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedUser\` varchar(255) NULL, \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`isLikeClicked\` tinyint NOT NULL, \`placeId\` int NULL, \`reviewId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`user_board_like\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdUser\` varchar(255) NULL DEFAULT 'PawPaw', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedUser\` varchar(255) NULL, \`updatedAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`isLikeClicked\` tinyint NOT NULL, \`userId\` int NULL, \`boardId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
